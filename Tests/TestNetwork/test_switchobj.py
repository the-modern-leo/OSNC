...
class test_cdp_neigbhor_interface(unittest.TestCase):
    ...
    for test in test_batch:
        try:
            ...
            interface_list = [("Ip address", test), ("Interface",), ("Status","Failed"), ("Error Message","No Active Connection"), ("config",)]
            excel_write.append(interface_list)
            continue
        s.getSwitchInfo()
        s.assignattributes()
